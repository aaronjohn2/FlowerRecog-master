...
Flower Classification using Oxford 102 Flower Dataset — I Made a Flower Recognition app by implementing a pre-trained Convolutional Neural Network to classify with relative accuracy as to what flower is in the image that one has taken.
